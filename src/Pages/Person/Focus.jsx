...
import { Ajax, Button, Pagination, Utils, Dialog } from 'yingview-form';
...
class focus extends Component {
  ...
  render() {
    const { byFocusList, total } = this.state;
    return (
      <div className="person-focus-wrap">
        <ul className="person-focus-list clearfix">
          {
            byFocusList && byFocusList.length ? byFocusList.map((user, index) => (
              <li className="person-focus-item" key={index}>
              ...
              (<li className="person-focus-empty">没有信息</li>)
          }
        </ul>
