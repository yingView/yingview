...
import { Ajax, Pagination, Utils, Dialog } from 'yingview-form';
...
class Album extends Component {
  ...
  render() {
    const { photoList, total } = this.state;
    return (
        ...
        <ul className="person-album-list clearfix">
          {
            photoList && photoList.length ? photoList.map((photo, index) => (
              <li className="person-album-item" key={index}>
              ...
              (<li className="person-album-empty">暂无图片</li>)
          }
        </ul>
