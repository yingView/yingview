...
class Fans extends Component {
  ...
  render() {
    const { focusList, total } = this.state;
    return (
      <div className="person-fans-wrap">
        <ul className="person-fans-list clearfix">
          {
            focusList && focusList.length ? focusList.map((user, index) => (
              <li className="person-fans-item" key={index}>
              ...
              (<li className="person-fans-empty">没有信息</li>)
          }
        </ul>
