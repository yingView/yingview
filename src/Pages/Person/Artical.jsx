...
import { Radio, FileUpload, Button, Pagination, Ajax, Utils, Dialog } from 'yingview-form';
import { Link } from 'react-router';

import Header from '../../components/Header';
import Footer from '../../components/Footer';

const { getCookie, deepCopy, decodeHTML } = Utils;
        ...
        return (
            <div className="person-artical-wrap">
                <ul className="person-artical-list">
                    {
                        articalList && articalList.length ? articalList.map((artical) => (
