...
class Admin extends Component {
  ...
  render() {
    ...
    const { userPhoto, nickName, userPower } = this.userInfo;
    return (
        ...
        <div id="ying-vue-mange-wrap">
          <div className="vue-mange-menu">
            <div className="vue-mange-top">
              <div className="photo">
                <img src={window.hostname + userPhoto} alt="" />
              </div>
            ...
            <ul className="vue-menu-list">
              ...
              {
                userPower === '7' || userPower === '8' || userPower === '9' ?
          ...
          <div className="vue-mange-content">
            <div className="time-and-user">
              ...
              <div className="user">
                <div className="photo"><img src={window.hostname + userPhoto} alt="" /></div>
